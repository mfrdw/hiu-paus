        ...
        <div class="login-box text-center">
            ...
            <form method="post" action="<?= base_url('login') ?>">
                <div class="mb-3 text-start">
                    <input type="text" name="identity" class="form-control form-control-lg"
            ...
            <p class="mb-2">
                Belum punya akun?
                <a href="<?= base_url('register') ?>" class="text-primary fw-semibold text-decoration-none">Daftar, yuk!</a>
            </p>
