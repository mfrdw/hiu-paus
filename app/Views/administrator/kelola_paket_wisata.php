                ...
                <div class="card my-3">
                    <div class="card-body">
                        <div class="d-flex justify-content-between">
                            <!-- Search Bar -->
                            <input type="text" class="form-control w-50" placeholder="Cari Wisata..."
                                aria-label="Search">
                            <!-- Add New Paket Button -->
                            <!-- Button (sudah ada) -->
                            <button class="btn btn-success" data-toggle="modal" data-target="#addEditModal">
                                <i class="fas fa-plus"></i> Tambah Wisata Baru
                            </button>
                                ...
                                <?php if (!empty($wisata) && is_array($wisata)): ?>
                                    ...
                                    <?php foreach ($wisata as $item): ?>
                                        <tr>
                                            ...
                                            <td>
                                                <?= $item['kategori'] == 'wisata_pilihan' ? 'Edukasi Wisata Hiu Paus' : 'Aktivitas Unggulan Di Taman Hiu Paus' ?>
                                            </td>
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <select name="kategori" class="form-control" required>
                            <option value="wisata_pilihan">Edukasi Wisata Hiu Paus</option>
                            <option value="wisata_unggulan">Aktivitas Unggulan Di Taman Hiu Paus</option>
                        </select>
                    </div>
                        ...
                        <div class="form-group">
                            ...
                            <select name="kategori" id="edit_kategori" class="form-control" required>
                                <option value="wisata_pilihan"
                                    <?= $item['kategori'] == 'wisata_pilihan' ? 'selected' : '' ?>>Edukasi Wisata Hiu Paus</option>
                                <option value="wisata_unggulan"
                                    <?= $item['kategori'] == 'wisata_unggulan' ? 'selected' : '' ?>>Aktivitas Unggulan Di Taman Hiu Paus</option>
                            </select>
                        </div>
